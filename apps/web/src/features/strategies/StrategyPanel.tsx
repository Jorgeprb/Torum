...
const booleanParamHelps: Record<string, string> = {
  ...
  pullback_live_anchor_to_low: "Ancla el PB vivo al minimo alcanzado, no al ultimo precio.",
  ...
  ath_green_prefer_x2_entries: "En zona ATH verde intenta entrar x2. Si no cabe por riesgo, baja a x1.",
          ...
          <div className="strategy-card__body strategy-card__summary">
            ...
            <div className="strategy-torum-settings">
              {[
                ...
                ["pullback_live_anchor_to_low", "Anclar PB vivo al minimo", torumParams.pullback_live_anchor_to_low !== false],
                ...
                ["ath_green_prefer_x2_entries", "x2 en verde ATH", torumParams.ath_green_prefer_x2_entries !== false],
